...
*/
    ...
    _menuitem_add_product->signal_activate().connect(sigc::mem_fun(*this, &Mainwin::on_add_product_click));
    ...
    _menuitem_list_products->signal_activate().connect(sigc::mem_fun(*this, &Mainwin::on_list_products_click));
...
/*
    ...
    _menuitem_add_order->signal_activate().connect(sigc::mem_fun(*this, &Mainwin::on_add_order_click));
    ...
    _menuitem_list_orders->signal_activate().connect(sigc::mem_fun(*this, &Mainwin::on_list_orders_click));
    ...
    menuitem_helps->signal_activate().connect(sigc::mem_fun(*this, &Mainwin::on_help_click));
    ...
    menuitem_test->signal_activate().connect(sigc::mem_fun(*this, &Mainwin::on_test_click));
...
void Mainwin::on_add_product_click() {
...
/*
void Mainwin::on_add_order_click() {
